  ...
  return (
    <div className="h-screen w-full bg-gradient-to-br from-primary-50 via-neutral-50 to-accent-50 animate-gradient overflow-hidden flex flex-col">
      ...
      <div className="flex-1 flex gap-2 p-2 animate-slide-up overflow-hidden">
        ...
        <div className="w-[8%] bg-white rounded-xl shadow-md p-2 flex flex-col">
          <h3 className="text-xs font-medium text-primary-700 mb-2 flex items-center">
            <svg className="w-3 h-3 mr-1 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            Samples
          </h3>
          <div className="flex flex-col space-y-2 overflow-y-auto scrollbar-thin scrollbar-thumb-primary-300 flex-1">
        ...
        <div className="w-[74%] flex flex-row gap-2 h-full">
          ...
          <div className="flex-1 bg-white rounded-xl shadow-md p-3 transition-all duration-300 hover:shadow-lg flex flex-col overflow-hidden">
            <h2 className="text-sm font-semibold text-primary-700 mb-2 flex items-center">
              <svg className="w-4 h-4 mr-1 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
